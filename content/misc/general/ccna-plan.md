...
I didn’t plan on taking the CCNA this soon. I always wanted to take the CCNA, eventually. The original plan was to take the Network+ first so that I have a solid foundation before jumping into a very difficult networking certification like the CCNA. Unfortunately, the universe had other plans for me. So, in the middle of my Network+ studies, my boss’s boss called me at 6 a.m. on a Monday morning to inform me that the CCNA class had a drop and asked if I wanted to take the seat. I agreed; what else was I supposed to say?

Less than 30 minutes later, I was sitting in a week-long CCNA class with about 10 other people from my organization. Up until about day 3, I was doing great because I have studied for the Network+ several times, just never really taken the exam. I also have a couple of other networking certifications. I would say my networking knowledge was somewhere around the Network+ level. Anyway, I was cruising no problem until about day 3… then we went DEEP. The last two final days of the class were kind of a blur, understanding some concepts and being pretty lost on others.

So, I have some studying to do. Here is the plan: my exam is scheduled for November 2nd, around 100 days from when I took the course. The pace at which I will have to learn will be intense. I have no other choice, as there is a timeframe by which I must take the exam.
...
As I study, I will be posting the concepts that I learn on this site. The intention is that this site will be a reference for me, notes I can access anywhere. But it may also double as a portfolio, showcasing how serious I am about my craft. 
