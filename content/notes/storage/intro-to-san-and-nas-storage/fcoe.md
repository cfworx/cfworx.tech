...
- 10Gbps Ethernet made room for storage and data traffic on one wire. FCoE encapsulates [FCP](/notes/storage/intro-to-san-and-nas-storage/fibre-channel-fcp-and-wwpn-addressing/) in an Ethernet header.
- Consolidation math per server: native FC needs 4 adapters, 4 cables, 4 switches (2 Ethernet + 2 FC); FCoE needs 2 of each.
- QoS guarantees the storage traffic its bandwidth. FC's reliability and performance carry over.
...
- Data and storage ride separate VLANs (see [VLANs](/notes/networking/ccna/cisco-u/vlans-and-access-ports/)).
