...
- The math is the same as normal subnetting, see [borrowing bits](/notes/networking/ccna/cisco-u/subnetting-and-borrowing-bits/) and [subnet increments](/notes/networking/ccna/cisco-u/subnetting-examples/). You just apply it more than once.
...
- RFC 1918 ranges and the registry system → [public and private IPv4 addresses](/notes/networking/ccna/cisco-u/public-private-ipv4-addresses/)
- Local vs directed broadcast, loopback, APIPA → [reserved IPv4 addresses](/notes/networking/ccna/cisco-u/reserved-ipv4-addresses/)
- ipconfig, ifconfig, ip addr → [verifying host IP settings](/notes/networking/ccna/cisco-u/verifying-host-ip-settings/)
