...
Application layer protocol underneath the whole web. Client-server: browser asks, web server answers, always in request-response pairs. Ports and transport basics → [common ports](/notes/networking/ccna/cisco-u/common-ports-and-protocols/).
