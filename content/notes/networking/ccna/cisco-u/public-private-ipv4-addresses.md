...
- Permanent fix: IPv6. Stopgaps that bought time: NAT, CIDR, private addressing (RFC 1918), and [VLSM](/notes/networking/ccna/cisco-u/vlsm-variable-length-subnet-masking/).
