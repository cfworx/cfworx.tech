...
draft: false
aliases: ["/certs/ccna/verifying-host-ip-settings/", "/certs/ccna/cisco-u/verifying-host-ip-settings/"]
---
...
- `ifconfig` plays the same role ipconfig plays on Windows: interface, IP, broadcast, mask, MAC, packet counters. The `lo` loopback interface shows 127.0.0.1 (see [reserved addresses](/notes/ccna/cisco-u/reserved-ipv4-addresses/)).
