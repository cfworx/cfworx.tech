...
draft: false
aliases: ["/certs/ccna/subnetting-examples/", "/certs/ccna/cisco-u/subnetting-examples/"]
---
...
Related: [borrowing bits and the subnet formulas](/notes/ccna/cisco-u/subnetting-borrowing-bits/), [subnet masks and the AND operation](/notes/ccna/cisco-u/subnet-masks-and-operation/).
