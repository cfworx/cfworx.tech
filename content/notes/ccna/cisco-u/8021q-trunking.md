...
draft: false
aliases: ["/certs/ccna/cisco-u/8021q-trunking/"]
---
...
- Access ports max out at two VLANs, and only via the [voice VLAN exception](/notes/ccna/cisco-u/vlans-and-access-ports/). Trunks are the many-VLAN case.
...
- 12 bits → 4096 possible IDs (0 and 4095 reserved, so 4094 usable, matching the [ID ranges](/notes/ccna/cisco-u/vlans-and-access-ports/)).
