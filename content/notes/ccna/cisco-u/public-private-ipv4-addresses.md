...
draft: false
aliases: ["/certs/ccna/public-private-ipv4-addresses/", "/certs/ccna/cisco-u/public-private-ipv4-addresses/"]
---

## Running out of IPv4

- 1990s internet growth made it obvious IPv4 space would not last.
- Permanent fix: IPv6. Stopgaps that bought time: NAT, CIDR, private addressing (RFC 1918), and [VLSM](/notes/ccna/cisco-u/vlsm-variable-length-subnet-masking/).
