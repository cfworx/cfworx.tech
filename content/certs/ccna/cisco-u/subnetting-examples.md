...
draft: false
aliases: ["/certs/ccna/subnetting-examples/"]
---
...
Related: [borrowing bits and the subnet formulas](/certs/ccna/cisco-u/subnetting-borrowing-bits/), [subnet masks and the AND operation](/certs/ccna/cisco-u/subnet-masks-and-operation/).
