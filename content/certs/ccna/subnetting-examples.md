...
Related: [borrowing bits and the subnet formulas](/certs/ccna/subnetting-borrowing-bits/), [subnet masks and the AND operation](/certs/ccna/subnet-masks-and-operation/).
