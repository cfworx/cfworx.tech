...
- The math is the same as normal subnetting, see [borrowing bits](/certs/ccna/subnetting-and-borrowing-bits/) and [subnet increments](/certs/ccna/subnetting-examples/). You just apply it more than once.
...
- RFC 1918 ranges and the registry system → [public and private IPv4 addresses](/certs/ccna/public-private-ipv4-addresses/)
- Local vs directed broadcast, loopback, APIPA → [reserved IPv4 addresses](/certs/ccna/reserved-ipv4-addresses/)
- ipconfig, ifconfig, ip addr → [verifying host IP settings](/certs/ccna/verifying-host-ip-settings/)
