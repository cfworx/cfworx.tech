...
- `ifconfig` plays the same role ipconfig plays on Windows: interface, IP, broadcast, mask, MAC, packet counters. The `lo` loopback interface shows 127.0.0.1 (see [reserved addresses](/certs/ccna/reserved-ipv4-addresses/)).
