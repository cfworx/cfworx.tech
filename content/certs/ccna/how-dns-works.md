...
DNS converts human-readable names into the IP addresses routing actually needs. Without it you'd memorize the address of every host you use. Port and transport details → [common ports](/certs/ccna/common-ports-and-protocols/).
