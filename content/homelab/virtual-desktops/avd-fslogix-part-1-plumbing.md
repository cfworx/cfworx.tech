---
title: "AVD + FSLogix part 1: the plumbing"
date: 2026-08-31
...
aliases:
  ...
  - "/homelab/virtual-desktops/avd-fslogix-lab/"
---
...
scaling," and this part is none of the interesting bits of that. It's
...
Part 2 is FSLogix: the registry settings on both hosts, the first
VHDX landing on the share, and labuser2's RemoteApp view. Part 3 is
the plan to break the permission layers on purpose and practice the
fixes, which is what the two-layer design and the low session limit
were for all along. Each gets written when it has actually happened.
