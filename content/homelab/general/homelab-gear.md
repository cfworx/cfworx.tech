---
title: "My $350 eBay CCNA lab is overkill, and that's fine"
date: 2026-08-30
description: "The gear behind the CCNA study plan: two Catalyst switches, two 1941 routers, a PA-220 firewall, a WiFi 6 access point, and a desk phone, all used, for about $350."
draft: false
---
...
So I went shopping on eBay. Total damage: about $350 for six pieces of used enterprise gear, and all of it is set up and running.

Is this overkill for one certification? *Absolutely*.

## The gear

Here's what $350 bought:
...
Bottom line: this is more lab than one certification needs, and I'm happy with it. For about $350 total, I get to run every topology in the study plan on the same kind of gear I'd touch at work, and the PA-220 keeps earning its spot after exam day, since Palo Alto is where work is headed anyway.
